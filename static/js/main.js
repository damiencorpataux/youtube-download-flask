...
function invalidinput() {
    ...
    //FIXME: handle video id constraint: 11 chars
    //       either say 'you've gone too far'
    //       or simply ignore the too many keyspresses
}
...
function notfound() {
    ...
    //FIXME: display the error message as a bootstrap alert
}
